...
export default function PhoneIllustration() {
  ...
  // Left bubbles need: space for longest text "All accounts, one place" ≈ 155px + padding
  // Right bubbles: "Smart categorization" ≈ 140px + padding
  ...
  return (
    <div style={{ position: 'relative', width: `${containerWidth}px`, height: `${containerHeight}px`, fontFamily: font, flexShrink: 0 }}>
          ...
          <div key={b.labelEn}>
            ...
            <svg style={{ position: 'absolute', top: `${arrowY - 6}px`, left: 0, width: `${containerWidth}px`, height: '12px', overflow: 'visible', pointerEvents: 'none' }}>
              ...
              <line
                ...
                strokeWidth="1"
                strokeDasharray="3,2"
                markerEnd={`url(#arr-${b.labelEn.replace(/\s/g,'-')})`}
              />
            </svg>
      ...
      <div style={{
        ...
        <div style={{ background: '#F5F5F0', borderRadius: '14px', height: 'calc(100% - 16px)', padding: '9px 7px', overflowY: 'hidden', direction: ar ? 'rtl' : 'ltr', fontFamily: font }}>
